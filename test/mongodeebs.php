<?php
    ...
    /* Adding
    $admin = array(
            'email'=>'jasondeichmann@yahoo.com',
            'name'=>'jason deichmann',
            'password' =>'admin',
            'usertype'=>'1'
    );
    $user = array(
            'email'=>'markbarraquias@gmail.com',
            'name'=>'mark barraquias',
            'password' =>'user',
            'usertype'=>'2'
    );

    curl_post('/db/accounts/', $admin);
    curl_post('/db/accounts/', $user);
    */
  ...
  <template>
    ...
    <div class="card">
      ...
      <iron-ajax
       ...
       <iron-ajax
            id = "dbCollectionPost"
            url = "http://127.0.0.1:8080/db/pets"
